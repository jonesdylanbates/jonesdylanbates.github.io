...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c8545d16573c1522c97fec8e8db30e2866e431c19dea97dcd7150ae42f6671bc.js',function(){input.required=false;search();});}
