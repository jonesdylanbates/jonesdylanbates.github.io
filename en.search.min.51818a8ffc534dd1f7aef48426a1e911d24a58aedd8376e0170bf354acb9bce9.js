...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/jonesdylanbates.github.io/flexsearch.min.js');loadScript('/jonesdylanbates.github.io/en.search-data.min.599fca981d41880daf8a5ace029563e36a2cd1fc4c60388d0d13a45ee2b0deee.js',function(){input.required=false;search();});}
