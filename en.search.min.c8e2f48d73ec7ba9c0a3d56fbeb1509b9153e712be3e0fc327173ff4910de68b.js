...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3d62e814adea93fbd0709369beb35c9d2a5e8810c2817fd3d93c7edcdad53867.js',function(){input.required=false;search();});}
